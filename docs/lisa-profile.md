...
"Lisa's Happy Nahrungsmittel" ist ein vordefiniertes, strenges Ernährungsprofil. Es hilft dabei, schnell zu erkennen, ob ein Produkt kritische (No-Go) oder unproblematische (Happy) Lebensmittel enthält.

## Happy Foods
Das sind Lebensmittel, die gemäß dem Profil unbedenklich sind.
Kategorien:
...
Lebensmittel, die absolut vermieden werden müssen, z.B.:
...
## Bewertungslogik
- **ROT (Kritisch):** Sobald mindestens ein No-Go-Food in der Zutatenliste gefunden wird. (No-Go überschreibt Happy Foods immer)
